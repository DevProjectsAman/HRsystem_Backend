...
{
    public record CreateCompanyCommand(int GroupId, string CompanyName) : IRequest<CreateCompanyResponse>;

    public record CreateCompanyResponse(int CompanyId, string CompanyName, int GroupId);
    ...
    public class CreateCompanyHandler : IRequestHandler<CreateCompanyCommand, CreateCompanyResponse>
    {
        ...
        public async Task<CreateCompanyResponse> Handle(CreateCompanyCommand request, CancellationToken cancellationToken)
        {
            ...
            return new CreateCompanyResponse(company.CompanyId, company.CompanyName, company.GroupId);
        }
    }
