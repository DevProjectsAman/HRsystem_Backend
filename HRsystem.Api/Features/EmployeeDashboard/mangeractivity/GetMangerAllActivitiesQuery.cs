...
namespace HRsystem.Api.Features.EmployeeDashboard.mangeractivity
{
    ...
    public class GetMangerAllActivitiesQueryHandler :
        IRequestHandler<GetMangerAllActivitiesQuery, List<AllActivityDto>>
    {
        private readonly DBContextHRsystem _db;
        private readonly ICurrentUserService _currentUserService;

        public GetMangerAllActivitiesQueryHandler(
        ...
        public async Task<List<AllActivityDto>> Handle(
            GetMangerAllActivitiesQuery request, CancellationToken ct)
        {
