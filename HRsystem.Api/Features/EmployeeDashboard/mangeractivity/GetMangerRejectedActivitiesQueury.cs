...
namespace HRsystem.Api.Features.EmployeeDashboard.GetRejectedActivities
{
    ...
    //}
    public class GetMangerRejectedActivitiesQueuryHandler : IRequestHandler<GetMangerRejectedActivitiesQueury, List<RejectedActivityDto>>
    {
        private readonly DBContextHRsystem _db;
        private readonly ICurrentUserService _currentUserService;
        public GetMangerRejectedActivitiesQueuryHandler(DBContextHRsystem db, ICurrentUserService currentUserService)
        {
            _db = db;
            _currentUserService = currentUserService;
        }
        public async Task<List<RejectedActivityDto>> Handle(GetMangerRejectedActivitiesQueury request, CancellationToken ct)
        {
