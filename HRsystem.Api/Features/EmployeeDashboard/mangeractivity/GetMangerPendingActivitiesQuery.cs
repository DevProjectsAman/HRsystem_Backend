...
namespace HRsystem.Api.Features.EmployeeDashboard.GetPendingActivities
{
    ...
    public record GetMangerPendingActivitiesQuery() : IRequest<List<PendingActivityDto>>;
    ...
    //}
    public class GetMangerPendingActivitiesQueryHandler : IRequestHandler<GetMangerPendingActivitiesQuery, List<PendingActivityDto>>
    {
        private readonly DBContextHRsystem _db;
        private readonly ICurrentUserService _currentUserService;
        public GetMangerPendingActivitiesQueryHandler(DBContextHRsystem db, ICurrentUserService currentUserService)
        {
            _db = db;
            _currentUserService = currentUserService;
        }
        public async Task<List<PendingActivityDto>> Handle(GetMangerPendingActivitiesQuery request, CancellationToken ct)
        {
