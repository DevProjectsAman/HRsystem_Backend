...
namespace HRsystem.Api.Features.EmployeeDashboard.GetApprovedActivites
{
    ...
    public class GetMangerApprovedActivitiesQueuryHandler : IRequestHandler<GetMangerApprovedActivitiesQueury, List<ApprovedActivityDto>>
    {
        private readonly DBContextHRsystem _db;
        private readonly ICurrentUserService _currentUserService;
        public GetMangerApprovedActivitiesQueuryHandler(DBContextHRsystem db, ICurrentUserService currentUserService)
        {
            _db = db;
            _currentUserService = currentUserService;
        }
        public async Task<List<ApprovedActivityDto>> Handle(GetMangerApprovedActivitiesQueury request, CancellationToken ct)
        {
