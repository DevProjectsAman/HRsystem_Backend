...
namespace HRsystem.Api.Features.EmployeeDashboard.GetPendingActivities
{
        ...
        : IRequestHandler<GetActivitiesStatusCountQuery, ActivitiesStatusCountDto>
    {
        ...
        public GetActivitiesStatusCountQueryHandler(DBContextHRsystem db, ICurrentUserService currentUserService, IActivityStatusLookupCache activityStatusLookupCache)
        {
            _db = db;
        ...
        public async Task<ActivitiesStatusCountDto> Handle(GetActivitiesStatusCountQuery request, CancellationToken ct)
        {
            ...
            int PendingStatusId = _activityStatusLookupCache.GetIdByCode(ActivityStatusCodes.Pending);
            int ApprovedStatusId = _activityStatusLookupCache.GetIdByCode(ActivityStatusCodes.Approved);
            int RejectedStatusId = _activityStatusLookupCache.GetIdByCode(ActivityStatusCodes.Rejected);
