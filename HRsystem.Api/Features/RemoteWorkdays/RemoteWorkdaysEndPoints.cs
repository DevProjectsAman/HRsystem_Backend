using HRsystem.Api.Features.RemoteWorkdays.CreateRemoteWorkday;
...
using HRsystem.Api.Features.RemoteWorkdays.UpdateRemoteWorkDays;
using MediatR;

namespace HRsystem.Api.Features.RemoteWorkDays
{
