...
namespace HRsystem.Api.Migrations
{
    ...
    [Migration("20260125091620_UserLoginHistory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRsystem.Api.Database.DataTables.TbEmployee", b =>
                {
                    ...
                    b.Property<string>("UniqueEmployeeCode")
                        .HasMaxLength(55)
                        .HasColumnType("varchar(55)");
            ...
            modelBuilder.Entity("HRsystem.Api.Database.DataTables.TbShiftRuleMappng", b =>
                {
                    b.Property<int>("RuleMappingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("RuleMappingId"));
            ...
            modelBuilder.Entity("HRsystem.Api.Database.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("MobileApplicationVersion")
                        .IsRequired()
                        .HasColumnType("longtext");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 25, 9, 16, 17, 107, DateTimeKind.Utc).AddTicks(4186),
                            ...
                            LastPasswordChangedAt = new DateTime(2026, 1, 25, 9, 16, 17, 107, DateTimeKind.Utc).AddTicks(7484),
                            ...
                            RowGuid = new Guid("3c05c6b9-aed6-43ef-82c9-3c8457e21e59"),
            ...
            modelBuilder.Entity("HRsystem.Api.Database.Entities.TbUserLoginHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Tb_User_Login_History");
                });

            modelBuilder.Entity("HRsystem.Api.Database.Entities.TbUserSession", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HRsystem.Api.Database.DataTables.TbShiftRuleMappng", b =>
                {
                    ...
                    b.HasOne("HRsystem.Api.Database.DataTables.TbShiftRule", "ShiftRule")
                        .WithMany()
            ...
            modelBuilder.Entity("HRsystem.Api.Database.Entities.TbUserLoginHistory", b =>
                {
                    b.HasOne("HRsystem.Api.Database.Entities.ApplicationUser", "User")
                        .WithMany()
